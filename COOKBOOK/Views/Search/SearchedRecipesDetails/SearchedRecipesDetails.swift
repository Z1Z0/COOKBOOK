...
@objc protocol SearchedRecipesDetailsDelegateAction: class {
    @objc func startCookingButtonTapped()
}

class SearchedRecipesDetails: UIView {
...
extension SearchedRecipesDetails: UITableViewDelegate, UITableViewDataSource {
