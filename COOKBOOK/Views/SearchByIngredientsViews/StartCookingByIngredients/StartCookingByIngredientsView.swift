//
//  StartCookingByIngredientsView.swift
//  COOKBOOK
//
...
class StartCookingByIngredientsView: UIView {
    
    weak var delegate: StartCookingDelegateAction?
    private let widthConstant: CGFloat = 1.3
    var vc = StartCookingByIngredientsViewController()
...
extension StartCookingByIngredientsView: UITableViewDelegate, UITableViewDataSource {
