//
//  StartBuyingByIngredientsView.swift
//  COOKBOOK
//
...
class StartBuyingByIngredientsView: UIView {
    
    private let widthConstant: CGFloat = 1.3
    weak var delegate: StartCookingDelegateAction?
    var vc = StartBuyingByIngredientsViewController()
...
extension StartBuyingByIngredientsView: UITableViewDelegate, UITableViewDataSource {
